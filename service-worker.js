const CACHE='legacy-in-stone-v0.6.4.3-core';
const CORE=['./','./index.html','./styles.css','./app.js','./storage.js','./cloud-config.js','./cloud.js','./v06-enhancements.js','./specimen-materials-direct.js','./manifest.webmanifest'];
